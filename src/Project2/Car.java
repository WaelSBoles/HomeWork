...
discount*/
    ...
    class Sedan extends Project2.Car {
        double length;
    ...
    class Truck extends Project2.Car {
        double weight;
        ...
        public static void main(String[] args) {
            ...
            Project2.Car sedan=new Sedan(35000.0,"White", 18.0);
            System.out.println(sedan.calculateSalePrice());

            Project2.Car truck=new Truck(45500.0,"Grey",150.0);
